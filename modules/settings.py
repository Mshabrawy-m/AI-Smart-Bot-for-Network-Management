...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "live_mode_caption": "Live mode pings real hosts (router + public DNS/web) and reads this machine's CPU/RAM/network via psutil. Simulated mode uses demo data.",
    ...
    "ar": {
        ...
        "live_mode_caption": "الوضع المباشر يرسل ping إلى المضيفين العامين ويقرأ CPU/RAM/الشبكة على هذا الجهاز عبر psutil. الوضع المحاكى يستخدم بيانات توضيحية.",
